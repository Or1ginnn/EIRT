...
class TrackingFlushTest(unittest.TestCase):
    ...
    def test_smoke_uses_shared_mandatory_search_reward(self):
        ...
        self.assertIn('THINK_FORMAT_SCORE="${THINK_FORMAT_SCORE:-0.2}"', runner)
        self.assertIn('ANSWER_FORMAT_SCORE="${ANSWER_FORMAT_SCORE:-0.1}"', runner)
        self.assertIn('EVIDENCE_SCORE="${EVIDENCE_SCORE:-0.0}"', runner)
        self.assertIn('ANSWER_EM_SCORE="${ANSWER_EM_SCORE:-1.2}"', runner)
        self.assertIn('JOINT_SUCCESS_BONUS="${JOINT_SUCCESS_BONUS:-0.0}"', runner)
