...
class MetricFilterTest(unittest.TestCase):
    ...
    def test_core_keeps_formal_metrics_and_dynamic_validation(self):
        metrics = {
            ...
            "actor/eitr_correction_normalization_scale": 0.5,
            "actor/eitr_correction_effective_lr": 1.5e-5,
            "actor/eitr_correction_unnormalized_update_norm": 6e-6,
            "actor/eitr_correction_predicted_update_norm": 3e-6,
            "actor/eitr_correction_max_update_norm": 3e-6,
            "actor/eitr_correction_min_update_norm": 3e-6,
            "actor/eitr_correction_skipped_weak_update": 1.0,
            "actor/eitr_post_diagnostic_noop": 1.0,
