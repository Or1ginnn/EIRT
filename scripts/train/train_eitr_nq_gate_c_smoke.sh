...
THINK_FORMAT_SCORE="${THINK_FORMAT_SCORE:-0.2}"
ANSWER_FORMAT_SCORE="${ANSWER_FORMAT_SCORE:-0.1}"
EVIDENCE_SCORE="${EVIDENCE_SCORE:-0.0}"
ANSWER_EM_SCORE="${ANSWER_EM_SCORE:-1.2}"
JOINT_SUCCESS_BONUS="${JOINT_SUCCESS_BONUS:-0.0}"
